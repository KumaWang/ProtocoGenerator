...
namespace iuiu.service
{
	...
	public static partial class FileService
	{
        ...
        public static string ParentPath 
        {
            get 
            {
                return Path.GetDirectoryName(Path.GetDirectoryName(ApplicationRootPath));
            }
        }
        ...
        public static string DataRootPath 
        {
            get 
            {
                return Path.Combine(ParentPath, "data");
            }
        }
        ...
        public static string TargetPath
        {
            get
            {
                return Path.Combine(DataRootPath, "targets");
            }
        }
        ...
        public static string ConfigPath 
        {
            get
            {
                return Path.Combine(DataRootPath, "config");
            }
        }
        ...
        public static string ImagesPath
        {
            get
            {
                return Path.Combine(DataRootPath, "images");
            }
        }
        ...
        public static string IconsPath
        {
            get
            {
                return Path.Combine(ImagesPath, "icons");
            }
        }
        ...
        public static string SDKPath 
        {
            get
            {
                return Path.Combine(DataRootPath, "sdk");
            }
        }
		...
		public static string GetWinSdkPath(string exeName) {
			string execPath;
...
//				erg.Append(Path.DirectorySeparatorChar);
        ...
        public static bool RemoveFile(string fileName, bool recover = true)
        {
